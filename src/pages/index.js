...
const api = new Api({
  ...
  headers: {
    ...
    //  //validate forms
     ...
     const popupFormAvatarProfile = document.querySelector('.popup__form_avatar-profile');
     ...
     const popupAvatarProfileValidator = new FormValidator(validationConfig, popupFormAvatarProfile);
